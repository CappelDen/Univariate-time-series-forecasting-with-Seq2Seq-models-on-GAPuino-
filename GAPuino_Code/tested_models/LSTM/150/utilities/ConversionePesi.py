...
model = h5py.File('27_9EDU1LSTM10T_150OneYear.h5', 'r')
input_seq_test = np.load('Input_seq_test.npy')
output_seq_test = np.load('Output_seq_test.npy')

dense_bias = np.array((((model['model_weights'])['dense_2'])['dense_2'])['bias:0'])
dense_kernel = np.array((((model['model_weights'])['dense_2'])['dense_2'])['kernel:0'])

Encoder_lstm_bias = np.array((((model['model_weights'])['rnn_3'])['rnn_3'])['bias:0'])
Encoder_lstm_kernel = np.array((((model['model_weights'])['rnn_3'])['rnn_3'])['kernel:0'])
Encoder_lstm_rec_ker = np.array((((model['model_weights'])['rnn_3'])['rnn_3'])['recurrent_kernel:0'])

Decoder_lstm_bias = np.array((((model['model_weights'])['rnn_4'])['rnn_4'])['bias:0'])
Decoder_lstm_kernel = np.array((((model['model_weights'])['rnn_4'])['rnn_4'])['kernel:0'])
Decoder_lstm_rec_ker = np.array((((model['model_weights'])['rnn_4'])['rnn_4'])['recurrent_kernel:0'])
