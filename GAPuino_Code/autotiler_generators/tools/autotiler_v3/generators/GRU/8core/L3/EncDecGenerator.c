...

{
    ...
    UserKernel(Name,
        ...
        KerArgs(11,
            ...
            KerArg("Rec_Kernel", KerArgSpace(1, T0),  O_IN|O_DB|O_L2DB, W, Neuroni, DataSize, 0, OBJ_CONSTRAINTS_TILE_VER|OBJ_CONSTRAINTS_PAD_REM, 0, "Rec_Kernel"),
            ...
            KerArg("Rec_Kernel2", KerArgSpace(1, T1),  O_IN|O_DB|O_L2DB, Neuroni, Neuroni, DataSize, 0, OBJ_CONSTRAINTS_TILE_VER|OBJ_CONSTRAINTS_PAD_REM, 0, "Rec_Kernel2"),
