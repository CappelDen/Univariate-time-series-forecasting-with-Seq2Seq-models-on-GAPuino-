...
void EncoderZGenerator(char *Name, unsigned int Neuroni, unsigned int in_step)

{
    ...
    UserKernel(Name,
        ...
        KerArgs(8,
            ...
            KerArg("H_0", KerArgSpace(1, T1),  O_IN|O_DB,  Neuroni, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "H_0"),
...

{
    ...
    UserKernel(Name,
        ...
        Calls(1,           
            Call("KerGRUEnclayer16", LOC_INNER_LOOP,
                Bindings(13,
                    K_Arg("z", KER_ARG_TILE),
                    K_Arg("In", KER_ARG_TILE),
                    C_Arg("Iterazione"),
        ...
        KerArgs(8,
            ...
            KerArg("Kernel", KerArgSpace(1, T1),  O_IN|O_DB, Neuroni, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM, 0, "Kernel"),
...
void DecoderZGenerator(char *Name, unsigned int Neuroni, unsigned int out_step)
