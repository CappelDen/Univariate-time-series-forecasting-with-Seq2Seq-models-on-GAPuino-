...

{
    ...
    UserKernel(Name,
        ...
        KerArgs(7,
            KerArg("In",KerArgSpace(1,T0), O_IN,  in_step, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "In"),
            KerArg("H_0", KerArgSpace(1, T0),  O_IN|O_OUT,  Neuroni, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "H_0"),
            KerArg("C_0", KerArgSpace(1, T0),  O_IN|O_OUT,  Neuroni, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "C_0"),
            KerArg("Kernel", KerArgSpace(1, T0),  O_IN,  W, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Kernel"),
            ...
            KerArg("Bias", KerArgSpace(1, T0),  O_IN,  W, 1, DataSize*2, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Bias"),
            KerArg("Z",KerArgSpace(1, T0),  O_OUT, W,  1,  DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Z")
        )
    );
}
...
void DecoderGenerator(char *Name, unsigned int Neuroni, unsigned int out_step)
{
    ...
    UserKernel(Name,
        ...
        KerArgs(9,
            ...
            KerArg("Rec_Kernel", KerArgSpace(1, T0),  O_IN|O_NTILED, W, Neuroni, DataSize, 0, OBJ_CONSTRAINTS_TILE_VER|OBJ_CONSTRAINTS_PAD_REM, 0, "Rec_Kernel"),
            KerArg("Bias", KerArgSpace(1, T0),  O_IN,  W, 1, DataSize*2, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Bias"),
            KerArg("Dense_Kernel", KerArgSpace(1, T0),  O_IN,  Neuroni, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Dense_Kernel"),
            KerArg("Dense_Bias", KerArgSpace(1, T0),  O_IN,  1, 1, DataSize*2, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Dense_Bias"),
            KerArg("Z",KerArgSpace(1, T0),  O_OUT, W,  1,  DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Z"),
            KerArg("Out",KerArgSpace(1, T0),  O_OUT, out_step,  1,  DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Out")        
        )
    );
