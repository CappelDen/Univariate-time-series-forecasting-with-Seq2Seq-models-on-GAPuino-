...
{
    LibKernel("KerZComputation16",CALL_SEQUENTIAL,
        CArgs(11,
    ...
    LibKernel("KerZComputationDec16",CALL_SEQUENTIAL,
        CArgs(9,
            TCArg("short int * __restrict__", "H_0"),
            TCArg("unsigned int", "W_H"),
            TCArg("short int * __restrict__", "Kernel"),
    ...
    LibKernel("KerLSTMlayer16",CALL_SEQUENTIAL,
        CArgs(5,
            TCArg("short int * __restrict__", "Z"),
...

{
    ...
    UserKernel(Name,
        ...
        Calls(2,
            ...
            Call("KerLSTMlayer16", LOC_INNER_LOOP,
                Bindings(5,
        ...
        KerArgs(7,
            KerArg("In",KerArgSpace(1,T0), O_IN|O_NTILED,  in_step, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "In"),
            KerArg("H_0", KerArgSpace(1, T0),  O_IN|O_OUT|O_NTILED,  Neuroni, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "H_0"),
            KerArg("C_0", KerArgSpace(1, T0),  O_IN|O_OUT|O_NTILED,  Neuroni, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "C_0"),
            KerArg("Kernel", KerArgSpace(1, T0),  O_IN|O_NTILED,  W, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Kernel"),
            KerArg("Rec_Kernel", KerArgSpace(1, T0),  O_IN|O_NTILED, W, Neuroni, DataSize, 0, OBJ_CONSTRAINTS_TILE_VER|OBJ_CONSTRAINTS_PAD_REM, 0, "Rec_Kernel"),
            KerArg("Bias", KerArgSpace(1, T0),  O_IN|O_NTILED,  W, 1, DataSize*2, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Bias"),
            KerArg("Z",KerArgSpace(1, T0),  O_OUT|O_NTILED, W,  1,  DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Z")
        )
    );
}
...
void DecoderGenerator(char *Name, unsigned int Neuroni, unsigned int out_step)
{
    ...
    UserKernel(Name,
        ...
        Calls(3,
            ...
            Call("KerDENSElayer16", LOC_INNER_LOOP,
                Bindings(7,
                    K_Arg("H_0", KER_ARG_TILE), K_Arg("H_0", KER_ARG_TILE_W),
        ...
        KerArgs(9,
            ...
            KerArg("Rec_Kernel", KerArgSpace(1, T0),  O_IN|O_NTILED, W, Neuroni, DataSize, 0, OBJ_CONSTRAINTS_TILE_VER|OBJ_CONSTRAINTS_PAD_REM, 0, "Rec_Kernel"),
            KerArg("Bias", KerArgSpace(1, T0),  O_IN|O_NTILED,  W, 1, DataSize*2, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Bias"),
            KerArg("Dense_Kernel", KerArgSpace(1, T0),  O_IN|O_NTILED,  Neuroni, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Dense_Kernel"),
            KerArg("Dense_Bias", KerArgSpace(1, T0),  O_IN|O_NTILED,  1, 1, DataSize*2, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Dense_Bias"),
            KerArg("Z",KerArgSpace(1, T0),  O_OUT|O_NTILED, W,  1,  DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Z"),
            KerArg("Out",KerArgSpace(1, T0),  O_OUT|O_NTILED, out_step,  1,  DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Out")        
        )
    );
