...

{
    ...
    UserKernel(Name,
        ...
        KerArgs(7,
            ...
            KerArg("C_0", KerArgSpace(1, T1),  O_IN|O_OUT|O_DB,  Neuroni, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "C_0"),
            KerArg("Kernel", KerArgSpace(1, T1),  O_IN|O_DB,  W, 1, DataSize, 0, OBJ_CONSTRAINTS_PAD_REM,                          0, "Kernel"),
            KerArg("Rec_Kernel", KerArgSpace(1, T0),  O_IN|O_DB|O_DB, W, Neuroni, DataSize, 0, OBJ_CONSTRAINTS_TILE_VER|OBJ_CONSTRAINTS_PAD_REM, 0, "Rec_Kernel"),
