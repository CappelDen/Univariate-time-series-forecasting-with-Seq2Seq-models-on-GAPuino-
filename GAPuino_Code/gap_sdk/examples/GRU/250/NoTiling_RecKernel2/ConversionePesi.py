...
model = h5py.File('27_27EDU1GRU10T_250OneYear.h5', 'r')
neuroni = 250
...
dense_bias = np.array((((model['model_weights'])['dense_4'])['dense_4'])['bias:0'])
dense_kernel = np.array((((model['model_weights'])['dense_4'])['dense_4'])['kernel:0'])

Encoder_lstm_bias = np.array((((model['model_weights'])['rnn_7'])['rnn_7'])['bias:0'])
Encoder_lstm_kernel = np.array((((model['model_weights'])['rnn_7'])['rnn_7'])['kernel:0'])
Encoder_lstm_rec_ker = np.array((((model['model_weights'])['rnn_7'])['rnn_7'])['recurrent_kernel:0'])

Decoder_lstm_bias = np.array((((model['model_weights'])['rnn_8'])['rnn_8'])['bias:0'])
Decoder_lstm_kernel = np.array((((model['model_weights'])['rnn_8'])['rnn_8'])['kernel:0'])
Decoder_lstm_rec_ker = np.array((((model['model_weights'])['rnn_8'])['rnn_8'])['recurrent_kernel:0'])
